...
public class AuthorizeFilter extends AbstractAuthenticationProcessingFilter {
  ...
  public AuthorizeFilter(RequestMatcher requiresAuthenticationRequestMatcher,
  ...
  public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
    ...
    if (refreshToken != null) {
      SubAutoLoginToken autoToken = new SubAutoLoginToken(clientId, redirectUri, refreshToken); 
      return super.getAuthenticationManager().authenticate(autoToken);
    }
